    ...
    return GestureDetector(
      onTap: () {
        if (selectedNotes.isNotEmpty) {
          ...
          if (widget.reading) {
            Get.find<ReaderLogic>().state. epubPlayerKey.currentState!.goToCfi(bookNote.cfi);
          } else {
                  ...
                  Row(
                    ...
                    children: [
                      sortButton(
                        context,
                        sheetState,
                        S.of(context).notes_page_sort_time,
                        'time',
                      ),
                      sortButton(
                        context,
                        sheetState,
                        S.of(context).notes_page_sort_chapter,
                        'cfi',
                      ),
                      const Spacer(),
                    ],
                  ...
                  Row(
                    children: [
                      ElevatedButton(
                          ...
                          child:
                              Text(S.of(context).notes_page_filter_reset)),
