...
import '../../../service/font.dart';
import '../../../utils/font_parser.dart';
  ...
  String getLabel(BuildContext context) {
    switch (this) {
      case PageTurn.noAnimation:
        return S.of(context).no_animation;
      case PageTurn.slide:
        return S.of(context).slide;
      case PageTurn.scroll:
        return S.of(context).scroll;
    }
  }
}
...
class _StyleWidgetState extends State<StyleWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          widgetTitle(
              S.of(context).reading_page_style, ReadingSettings.theme),
          sliders(),
          fontAndPageTurn(),
          const Divider(),
          themeSelector(),
  ...
  List<FontModel> fonts() {
    ...
    List<FontModel> fontList = [
      FontModel(
        label: S.of(context).add_new_font,
        name: 'newFont',
        path: '',
      ),
      FontModel(
        label: S.of(context).follow_book,
        name: 'book',
        path: '',
      ),
      FontModel(
        label: S.of(context).system_font,
        name: 'system',
        path: 'system',
      ),
    ];
    ...
    return Row(children: [
      Expanded(
        child: DropdownMenu<PageTurn>(
          label: Text(S.of(context).reading_page_page_turning_method),
          ...
          onSelected: (PageTurn? value) {
            if (value != null) {
              ...
              widget.epubPlayerKey.currentState!.changePageTurnStyle(value);
            }
          },
